...
WITH total_amount_paid (customer_id, first_name, last_name, total_amount, city, country) AS
  (SELECT
	  B.customer_id,
	  B.first_name,
	  B.last_name,
...
WITH top_5_customers (customer_id, first_name, last_name, total_amount, city, country) AS
 (SELECT
	B.customer_id,
  	B.first_name,
  	B.last_name,
